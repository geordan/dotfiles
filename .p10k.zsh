# Generated by Powerlevel10k configuration wizard on 2022-09-16 at 07:50 MST.
...
# dotted, right frame, dark-ornaments, compact, many icons, fluent, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%162F'   # green foreground
